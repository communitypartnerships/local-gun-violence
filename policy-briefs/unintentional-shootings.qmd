...
```{r out.width='50%', fig.align='center', fig.alt="Text box, 8 kids a day are unintentionally killed or injured with an unlocked or unsupervised gun in the home."}
knitr::include_graphics('../images/unintentional_estimate_box.png')
```
...
```{r out.width='100%', fig.align='center', fig.alt="Chart showing Gun Laws and Gun Deaths in the US, comparing Virginia, Southern States and Non-southern states."}
knitr::include_graphics('../images/butterfly_v2.png')
```
