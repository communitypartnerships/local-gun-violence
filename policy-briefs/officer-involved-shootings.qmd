...
```{r out.width='50%', fig.align='center', fig.alt="Chart showing how 2024 compares with previous calendar years. The number of fatal police shootings has risen in recent years. Police killed the highest number of people on record in 2024."}
knitr::include_graphics('../images/wp_police_incidents.png')
```
...
```{r out.width='60%', fig.align='center', fig.alt="Chart showing Police killed 4 more people in Virginia in 2024 compared to the previous year. 32 total killings by police in 2024."}
knitr::include_graphics('../images/police_va.png')
```
