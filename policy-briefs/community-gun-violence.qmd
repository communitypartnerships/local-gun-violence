...
```{r out.width='70%', fig.align='center', fig.alt="Image with text, 48,204 people died from firearms in the U.S. the second-highest total ever recorded. Someone was killed by a gun every 11 minutes."}
knitr::include_graphics('../images/jhu_firearm_deaths.png')
```
...
```{r fig.align='center', fig.cap="Figure Source: JHU[^8]", fig.alt="Chart showing Difference in Gun Homicide Rats by Race and Age, 2022."}
knitr::include_graphics('../images/jhu_homicide_agerace.png')
```
...
```{r, fig.alt="Chart showing Gun Death Rate per 100,000 for youth (ages 1-19) by Urbanization in 2022."}
knitr::include_graphics('../images/jhu_urban_rural.png')
```
