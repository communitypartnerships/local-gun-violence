...
![](../images/everytown_ipv.png){fig-alt="Chart showing Intimate partner homicides of women by guns are on the rise, years 2014-2023."}
...
```{r out.width='60%', fig.align='center', fig.alt="Chart showing Weapons in Reported IPV Incidents."}
knitr::include_graphics('../images/va_data.png')
```
